    ...
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      <div className="flex flex-col lg:flex-row w-full py-8">
        ...
        <div className="w-full lg:w-1/2 p-8">
          <h1 className="mx-auto max-w-4xl font-display text-left	text-4xl font-medium tracking-tight text-slate-900 sm:text-6xl">
            {/* The {' '}
            <span className="relative whitespace-nowrap text-amber-600">
              ...
              <span className="relative">Decentralized Identity</span>
            </span>{' '}
            <p>for Web3 Developers</p> */}
            <p className='my-3'>
              The{' '}
            ...
            <p className='my-3'>Developers</p>

          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-left text-lg tracking-tight text-slate-700">
            Contribute to the Web3 ecosystem with verifiable profiles
          </p>
          <div className="mt-10 flex justify-left space-x-6 text-left">
            <ButtonLink href="https://docs.committable.io/en/overview/" color="blue" target="_blank" rel="noopener noreferrer">
              Learn More
            </ButtonLink>
            {/* <ButtonLink
          href="https://youtu.be/6f6IUGV35Gw"
          variant="outline"
        >
          <svg
            aria-hidden="true"
